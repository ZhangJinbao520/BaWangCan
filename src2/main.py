...
if __name__ == '__main__':
    ...
    CityId = Config().getConfig('City', 'CityId')
    userNickName = Config().getConfig('userNickName', 'userNickName')
    SCKEY = Config().getConfig('SCKEY', 'SCKEY')
    BaWangCan = runResultThread(Cookie, userNickName, CityId)
    BaWangCan.SCKEY = SCKEY
    BaWangCan.run()
