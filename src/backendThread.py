...
class runResultBackendThread(QtCore.QThread):
    ...
    def __init__(self, cookie=None, city=None, userNickName=None):
        super().__init__()
        self.Cookie = cookie
        self.City = city
    ...
    # @staticmethod
    # def runBaWangCan(cookie, activatyID):
